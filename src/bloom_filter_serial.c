/**
 * @file    bloom_filter_serial.c
 * @brief   Serial implementation of Bloom Filter.
...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(argv[1], "sha256") == 0) {
        ...
        printf("Bloom Filter with SHA256 - Serial\n");
    } else if (strcmp(argv[1], "murmurhash3") == 0) {
        hashType = HASH_MURMURHASH3;
        printf("Bloom Filter with MurmurHash3 - Serial\n");
    } else {
    ...
    printf("Number of distinct words inserted:                      %d\n", numDistinctWords);
